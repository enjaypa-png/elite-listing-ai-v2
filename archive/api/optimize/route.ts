...
═══════════════════════════════════════════════════════════════
🎯 ETSY'S 2025 ALGORITHM - 8 RANKING FACTORS (PRIORITY ORDER)
═══════════════════════════════════════════════════════════════
1. Listing Quality Score (30% weight) - CTR, conversion, favorites, sales velocity, image quality
2. Conversion Rate (25% weight) - Orders ÷ Visits × 100 (target: 3%+ competitive, 4%+ excellent)
...
═══════════════════════════════════════════════════════════════
📊 285-POINT SCORING SYSTEM
═══════════════════════════════════════════════════════════════

🏆 TITLE OPTIMIZATION (50 points max):
✅ Primary keyword in first 5 words: 15 pts
✅ Buyer intent phrases (e.g., "gift for mom", "personalized wedding"): 10 pts
✅ Readability maintained (not keyword-stuffed): 10 pts
✅ Character count 60-140: 5 pts
✅ Multi-word keyword phrases vs single words: 5 pts
✅ Unique from seller's other listings: 5 pts

CRITICAL TITLE RULES:
• Front-load primary keyword while staying readable
• Use buyer intent language, not just product descriptors
• NO keyword stuffing (algorithm penalizes in 2025)

EXAMPLE:
❌ BAD: "Print Art Wall Decor Poster Modern Minimalist Design"
✅ GOOD: "Modern Minimalist Wall Art Print | Scandinavian Bedroom Decor | Instant Download"

---

🏷️ TAGS OPTIMIZATION (35 points max):
✅ 13 tags used (maximum): 10 pts
✅ Tags reinforce title keywords: 8 pts
✅ Long-tail variations included: 7 pts
✅ No duplicate category/attribute terms: 5 pts
✅ Mix of broad + specific terms: 5 pts
...
CRITICAL TAG RULES:
• DON'T repeat category/attribute words - they auto-populate as tags
• Use long-tail (e.g., "boho nursery wall art" not just "wall art")
• Vary across listings - identical terms dilute effectiveness

---

📝 DESCRIPTION OPTIMIZATION (30 points max):
✅ First 160 characters compelling + keyword-rich: 10 pts (search snippet!)
✅ Benefits highlighted over features: 6 pts
✅ Answers common buyer questions: 6 pts
✅ Natural keyword integration (not stuffed): 5 pts
✅ Clear size/dimension info: 3 pts
...
═══════════════════════════════════════════════════════════════
❌ CRITICAL DON'TS (Instant Penalties):
═══════════════════════════════════════════════════════════════
• DON'T keyword stuff - algorithm actively penalizes
• DON'T use identical keywords across listings
• DON'T repeat category words in tags
• DON'T ignore mobile (44%+ traffic from app)
• DON'T rely on old tactics - 2025 is behavior-driven
